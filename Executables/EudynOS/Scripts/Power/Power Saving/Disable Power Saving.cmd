...
whoami /user | find /i "S-1-5-18" > nul 2>&1 || (
	call %windir%\EudynOS\Scripts\RunAsTI.cmd "%~f0" %*
	exit /b
)
...
:main
powercfg /l | find "Power Scheme GUID: 11111111-1111-1111-1111-111111111111  (EudynOS Power Scheme)" > nul || (
...
:: Set current power scheme
powercfg /changename scheme_current "EudynOS Power Scheme" "Power scheme optimized for optimal latency and performance."
...
powercfg /setacvalueindex scheme_current 0012ee47-9041-4b5d-9b77-535fba8b1442 501a4d13-42af-4429-9fd1-a8218c268e20 0

:: Set the active scheme as the current scheme
powercfg /setactive scheme_current

:: Disable Advanced Configuration and Power Interface (ACPI) devices
call %windir%\EudynOS\Scripts\toggleDev.cmd @("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI") > nul
